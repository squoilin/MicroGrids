...
def Model_Creation(model):
    ...
    model.PV_Energy_Production = Param(model.periods, within=NonNegativeReals, initialize=Initialize_PV_Energy) # Energy produccion of a solar panel in W
    ...
    model.Energy_Demand = Param(model.periods, initialize=Initialize_Demand) # Energy Energy_Demand in W 
    ...
    model.Total_Energy_PV = Var(model.periods, within=NonNegativeReals) # Energy generated for the Pv sistem in Wh
    ...
    model.Diesel_Consume = Var(model.periods, within=NonNegativeReals) # Diesel consumed to produce electric energy in L
    model.Generator_Energy = Var(model.periods, within=NonNegativeReals) # Energy generated for the Diesel generator
