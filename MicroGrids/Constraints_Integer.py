...
def Generator_Bounds_Min_Integer(model,s,t): # Maximun energy output of the diesel generator
    ''' 
    This constraint ensure that each segment of the generator does not pass a 
    minimun value.
    :param model: Pyomo model as defined in the Model_creation library.
    '''
    return model.Generator_Nominal_Capacity*model.Generator_Min_Out_Put + (model.Generator_Energy_Integer[s,t]-1)*model.Generator_Nominal_Capacity <= model.Generator_Total_Period_Energy[s,t]                                                                                                
                                                                                               
def Generator_Bounds_Max_Integer(model,s,t): # Maximun energy output of the diesel generator
    ''' 
    This constraint ensure that each segment of the generator does not pass a 
    minimun value.
    :param model: Pyomo model as defined in the Model_creation library.
    '''
    return model.Generator_Total_Period_Energy[s,t] <= model.Generator_Nominal_Capacity*model.Generator_Energy_Integer[s,t]                                                                                                

def Generator_Cost_1_Integer(model,s,t):
    ''' 
    This constraint calculate the cost of each generator in the time t.
    :param model: Pyomo model as defined in the Model_creation library.
    '''
    return model.Period_Total_Cost_Generator[s,t] ==  model.Generator_Energy_Integer[s,t]*model.Start_Cost_Generator + model.Marginal_Cost_Generator*model.Generator_Total_Period_Energy[s,t]  

def Energy_Genarator_Energy_Max_Integer(model,s,t):
    ''' 
