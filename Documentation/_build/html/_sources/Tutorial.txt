...
First of all Micro-Grids needs Python 2.7.10 install in the computer. The easiest way to obtain it, is download `anaconda`_ in order to have all the tools needed to run python scripts.
...
PlotTime                            param: PlotTime := 1;			            Can be more than 1 
...
DieselCost                          param: Diesel_Cost := 1.18;                        
...
The PV_Energy.xls file has to have the energy yield for one PV in each period of analysis. The excel file must have a column with the periods and another with energy yield in W as shown in the following figure.
...
Name of the file                 type of file   Description                       
===============================  =============  ===============================================================================================
Size.xls                         Txt file 	Contains the nominal capacities of the PV, Battery, Diesel generator and the NPV of the system
